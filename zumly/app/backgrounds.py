...
Pattern sub-types: waves, stripes, dots, grid, rings, checker, and chevron.
"""
...
class BackgroundPreset:
    ...
    name: str
    kind: str  # solid/gradient/radial/spotlight or a supported pattern kind
...
PATTERN_KINDS = {"wavy", "stripes", "dots", "grid", "rings", "checker", "chevron"}
...
PRESETS: List[BackgroundPreset] = [
    ...
    # Geometric patterns. These use the same renderer in thumbnails, preview,
    # and export so the swatch is an honest miniature of the final canvas.
    BackgroundPreset("Slate Stripes",     "stripes", (100, 116, 139), (15, 23, 42)),
    BackgroundPreset("Coral Stripes",     "stripes", (251, 113, 133), (69, 10, 10)),
    BackgroundPreset("Azure Dots",        "dots",    (125, 211, 252), (8, 47, 73)),
    BackgroundPreset("Berry Dots",        "dots",    (244, 114, 182), (80, 7, 36)),
    BackgroundPreset("Blueprint Grid",    "grid",    (56, 189, 248),  (8, 32, 55)),
    BackgroundPreset("Graphite Grid",     "grid",    (163, 163, 163), (38, 38, 38)),
    BackgroundPreset("Aurora Rings",      "rings",   (94, 234, 212),  (30, 27, 75)),
    BackgroundPreset("Sunset Rings",      "rings",   (251, 191, 36),  (127, 29, 29)),
    BackgroundPreset("Mono Checker",      "checker", (229, 229, 229), (82, 82, 82)),
    BackgroundPreset("Indigo Checker",    "checker", (129, 140, 248), (30, 27, 75)),
    BackgroundPreset("Violet Chevron",    "chevron", (192, 132, 252), (59, 7, 100)),
    BackgroundPreset("Mint Chevron",      "chevron", (110, 231, 183), (6, 78, 59)),
]
